        ...
        <form action="{{ route('discount.store') }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="discount_event_name" aria-describedby="discount_event_name"
              placeholder="Nhập tên sự kiện giảm giá" name="discount_event_name" value="{{ old('discount_event_name') }}">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="discount_percent" aria-describedby="discount_percent"
              placeholder="Nhập phần trăm giảm giá" name="discount_percent" value="{{ old('discount_percent') }}">
