...
@section('main-content')
  <div class="container">
    ...
    <div class="row">
      <div class="container">
        <h1 class="text-center my-4">CẬP NHẬT PHIẾU GIẢM GIÁ </h1>
        <form action="{{ route('coupon.update', ['coupon' => $coupon]) }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="coupon_code" aria-describedby="coupon_code"
              placeholder="Enter Coupon Code" name="coupon_code" value="{{ $coupon->coupon_code }}">
          ...
          <div class="form-group">
            ...
            <input type="number" class="form-control" id="coupon_price_discount" aria-describedby="coupon_price_discount"
              name="coupon_price_discount" value="{{ $coupon->coupon_price_discount }}">
            @include('common.singleAlertError', ['field' => 'coupon_price_discount'])
          </div>
          <div class="form-group">
            <label for="coupon_use_number" class="text-capitalize">Sô lượng phiếu tồn:</label>
            <input type="number" class="form-control" id="coupon_use_number" aria-describedby="coupon_use_number"
              name="coupon_use_number" value="{{ $coupon->coupon_use_number }}">
