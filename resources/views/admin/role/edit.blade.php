        ...
        'role'=>$role->id
          ...
          <div class="col-md-12">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="role_name" aria-describedby="role_name" name="role_name" value="{{$role->role_name}}" placeholder="Nhập tên vai trò">
            </div>
            <div class="form-group">
              <label for="role_description">Mô tả:</label>
              <textarea name="role_description" id="ckeditor_user_role_edit" cols="30" rows="10" class="form-control" placeholder="Enter Role Description">{{$role->role_description}}</textarea>
            </div>
          </div>
            <div class="col-md-12">
                <div class="row">
