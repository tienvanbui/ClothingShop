...
@section('main-content')
  <div class="container">
    ...
    <div class="row">
      <h1 class="text-center mt-4">CẬP NHẬT VAI TRÒ</h1>
      ...
      <form action="{{ route('role.update', [
        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="role_name" aria-describedby="role_name" name="role_name"
              value="{{ $role->role_name }}" placeholder="Nhập tên vai trò">
          </div>
          <div class="form-group">
            <label for="role_description">Mô tả:</label>
            <textarea name="role_description" id="ckeditor_user_role_edit" cols="30" rows="10" class="form-control"
              placeholder="Enter Role Description">{{ $role->role_description }}</textarea>
          </div>
        </div>
        <div class="col-md-12">
          <div class="row">
                      ...
                      <h5 class="card-title">
                        <label>
                          <input type="checkbox" name="permission_id[]" class="checkbox_childrent"
                            value={{ $child->id }} multiple
                            {{ $pemissionOfRole->contains('id', $child->id) ? 'checked' : '' }}>
                        </label>
