...
@section('main-content')
  <div class="container">
          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            <div class="d-md-flex">
              ...
              <a href="{{ route('banner.create') }}"
                class="btn btn-success  d-none d-md-block pull-right ms-3 hidden-xs hidden-sm waves-effect waves-light text-white">Tạo banner</a>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="row">
      <div class="container">
        <h1 class="text-center">TẠO THÔNG TIN BANNER</h1>
        <form method="POST" action="{{ route('banner.store') }}" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <textarea name="content" cols="30" rows="5" class="form-control" id="ck_banner_create"></textarea>
