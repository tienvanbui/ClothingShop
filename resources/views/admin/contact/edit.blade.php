          ...
          <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">z
            <div class="d-md-flex">
              <ol class="breadcrumb ms-auto">
                @if (auth()->user()->hasPermission('Contact_list'))
                  <li><a href="{{ route('contact.index') }}" class="fw-normal">Contact Information</a></li>
                @endif
              </ol>
              @if (auth()->user()->hasPermission('Contact_create'))
        ...
        <form action="{{ route('contact.update', ['contact' => $contact]) }}" method="post">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="address" aria-describedby="address"
              placeholder="Enter address of your shop" name="address" value="{{ $contact->address }}">
            @include('common.singleAlertError', ['field' => 'address'])
          </div>
          <div class="form-group">
            <label for="talk">Lets Talk</label>
            <input type="text" class="form-control" id="talk" aria-describedby="talk" placeholder="Lets Talk"
              name="talk" value="{{ $contact->talk }}">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" id="sale_email" aria-describedby="sale_email"
              placeholder="Enter Sales Email Support" name="sale_email" value="{{ $contact->sales_email }}">
