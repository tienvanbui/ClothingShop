...
@section('main-content')
  <div class="container">
    ...
    <div class="row">
      <div class="col-12">
        <h1 class="text-center my-4">DANH SÁCH DANH MỤC SẢN PHẨM</h1>
        ...
        <div id="admin-data">
          @include('admin.category.category-item')
        </div>
        <input type="hidden" id="hidden_page_admin" value="1" />
        <input type="hidden" id="hidden_table" value="categories" />
        <input type="hidden" id="hidden_view" value="admin.category.category-item" />
