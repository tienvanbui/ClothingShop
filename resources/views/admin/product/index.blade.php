  ...
  <div class="container">
    ...
    <div class="row">
      <div class="container">
        ...
        <div id="admin-data">
          @include('admin.product.product-item')
        </div>
        <input type="hidden" id="hidden_page_admin" value="1" />
        <input type="hidden" id="hidden_table" value="products" />
        <input type="hidden" id="hidden_view" value="admin.product.product-item" />
        <input type="hidden" id="hidden_col" value="product_name" />
      </div>
