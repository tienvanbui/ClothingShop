@php
$isAdmin = true;
$pathUri = parse_url(url()->current(),PHP_URL_PATH);
$pathUri = explode('/',$pathUri);
$userRoleWannerLogin = $pathUri[1] == "admin" ? $isAdmin = true : $isAdmin = false;
@endphp
@extends('layouts.app')
@section('title')
Đăng nhập
...
<div class="row justify-content-center">
  <div class="col-md-6 col-lg-4" style="padding-bottom: 12%">
